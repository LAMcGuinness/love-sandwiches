...
def get_sales_data():
    """
    Get sales figure data from the user.
...
def validate_data(values):
    """
    Inside the try, covery all string values into intergers.
...
def update_surplus_worksheet(data):
    ...
    print("Surplus worksheet updates successful.\n")

def calculate_surplus_data(sales_row):
    """
    compare sales with the stock and calculate the surplus for each item.
    The surpluse is defined as sales subtracted from the stock:
